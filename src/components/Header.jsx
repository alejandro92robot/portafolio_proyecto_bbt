...
const Info = () => {
    return (
        <>
            <Box
                sx={{
                    background: 'linear-gradient(135deg, #0079E4 1%, #00B4D8 100%)', // Gradiente de azul
                    minHeight: '45vh',
                    color: 'white',
                    textAlign: 'center',
                    paddingX: { xs: 2, md: 4 },
            ...
            >
                <Box
                    ...
                    sx={{
                        width: { xs: '80%', sm: '75%', md: '40%' }, // Reducido al 20% en desktop
                        margin: '25px',
                        borderRadius: '20px',
                        animation: 'zoomInOut 4s ease-in-out infinite', // Aquí aplicamos la animación directamente
                    }}
                />
            </Box>
